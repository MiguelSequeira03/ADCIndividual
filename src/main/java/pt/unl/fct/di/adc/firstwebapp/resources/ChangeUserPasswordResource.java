...
import pt.unl.fct.di.adc.firstwebapp.util.changepassword.ChangePasswordInput;
import pt.unl.fct.di.adc.firstwebapp.util.changepassword.ChangePasswordRequest;
...
public class ChangeUserPasswordResource {
    ...
    public static final String PWD_UPDATED = "Password changed successfully";
    ...
    public Response ChangeUserRole(ChangePasswordRequest request) {
    	...
    	if (tokenEnt == null) {
           ...
           try {
               ...
               if (!user.getString(USER_PWD).equals(DigestUtils.sha512Hex(input.oldPassword))) {
            	   JsonObject error = new JsonObject();
               ...
               if(!input.username.equals(token.username)) {
                  	JsonObject error = new JsonObject();
               ...
               Entity updatedUser = Entity.newBuilder(user)
           	        .set(USER_PWD, DigestUtils.sha512Hex(input.newPassword))
           	        .build();
               ...
               message.addProperty("message", PWD_UPDATED);
