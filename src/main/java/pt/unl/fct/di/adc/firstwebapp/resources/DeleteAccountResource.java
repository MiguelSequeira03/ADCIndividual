...
public class DeleteAccountResource {
    ...
    public static final String ACCOUNT_DELETED = "Account deleted succefully";
    ...
    public Response DeleteAccount(UsernameTokenRequest request) {
    	...
    	if (tokenEnt == null) {
         ...
         try {
             ...
             message.addProperty("message", ACCOUNT_DELETED);
             
             JsonObject responseData = new JsonObject();
             responseData.add("data", message);
